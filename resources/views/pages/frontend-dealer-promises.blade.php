...
<head>
    ...
    <title>AA Dealer Promise - Prime Carz Ltd</title>
        ...
        <div class="main-container col2-right-layout">
            ...
            <div class="main container">
                <div class="row">
                    ...
                    <div class="col-main col-sm-8 wow bounceInUp animated animated ">
                        <div class="form_background" style="visibility: visible;">

                            <p> ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                            ...
                            <br>
                            <p> standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                                and scrambled it to make a type specimen book. It has survived not only five centuries,
                                but also the leap into electronic typesetting, remaining essentially unchanged. It was
                                popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum
                                passages, and more recently with desktop publishing software like Aldus PageMaker
                                including versions of Lorem IpsumLorem Ipsum is simply dummy text of the printing and
                            ...
                            <br>
                            <p> dummy text ever since the 1500s, when an unknown printer took a galley of type and
                    ...
                    <aside class="col-right sidebar col-sm-4 wow bounceInUp animated animated"
